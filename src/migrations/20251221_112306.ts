...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  await db.execute(sql`
   CREATE TYPE "public"."_locales" AS ENUM('en', 'fr');
    ...
    CREATE TYPE "public"."enum_businesses_membership_status" AS ENUM('active', 'inactive');
    ...
    CREATE TYPE "public"."enum__businesses_v_version_membership_status" AS ENUM('active', 'inactive');
    ...
    CREATE TYPE "public"."enum__announcements_v_published_locale" AS ENUM('en', 'fr');
  ...
  await db.execute(sql`
    ...
    CREATE TABLE "businesses" (
  	...
  	"membership_status" "enum_businesses_membership_status" DEFAULT 'active',
  	"generate_slug" boolean DEFAULT true,
  	"slug" varchar,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
    ...
    CREATE TABLE "_businesses_v" (
  	...
  	"version_membership_status" "enum__businesses_v_version_membership_status" DEFAULT 'active',
  	"version_generate_slug" boolean DEFAULT true,
  	"version_slug" varchar,
  	"version_updated_at" timestamp(3) with time zone,
  	"version_created_at" timestamp(3) with time zone,
    ...
    CREATE TABLE "events" (
  	...
  	"featured" boolean DEFAULT false,
  	"event_status" "enum_events_event_status" DEFAULT 'published',
  	"generate_slug" boolean DEFAULT true,
  	"slug" varchar,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
    ...
    CREATE TABLE "_events_v" (
  	...
  	"version_featured" boolean DEFAULT false,
  	"version_event_status" "enum__events_v_version_event_status" DEFAULT 'published',
  	"version_generate_slug" boolean DEFAULT true,
  	"version_slug" varchar,
  	"version_updated_at" timestamp(3) with time zone,
  	"version_created_at" timestamp(3) with time zone,
  ...
  await db.execute(sql`
    ...
    CREATE TABLE "_announcements_v" (
  	...
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"snapshot" boolean,
  	"published_locale" "enum__announcements_v_published_locale",
  	"latest" boolean,
  	"autosave" boolean
  );
