...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_businesses_social_links_platform" AS ENUM('facebook', 'instagram', 'twitter', 'linkedin', 'youtube');
  CREATE TYPE "public"."enum_businesses_advertising_slots_type" AS ENUM('image', 'video', 'offer');
  CREATE TYPE "public"."enum_businesses_membership_status" AS ENUM('active', 'inactive', 'pending');
  CREATE TYPE "public"."enum_businesses_payment_status" AS ENUM('pending', 'paid', 'overdue');
  CREATE TYPE "public"."enum_businesses_approval_status" AS ENUM('pending', 'approved', 'rejected');
  CREATE TYPE "public"."enum_businesses_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__businesses_v_version_social_links_platform" AS ENUM('facebook', 'instagram', 'twitter', 'linkedin', 'youtube');
  CREATE TYPE "public"."enum__businesses_v_version_advertising_slots_type" AS ENUM('image', 'video', 'offer');
  CREATE TYPE "public"."enum__businesses_v_version_membership_status" AS ENUM('active', 'inactive', 'pending');
  CREATE TYPE "public"."enum__businesses_v_version_payment_status" AS ENUM('pending', 'paid', 'overdue');
  ...
  CREATE TYPE "public"."enum_banners_active_banners_style" AS ENUM('info', 'warning', 'error', 'success');
  ...
  CREATE TABLE "businesses_social_links" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"platform" "enum_businesses_social_links_platform",
  	"url" varchar
  );
  ...
  CREATE TABLE "businesses" (
  	...
  	"membership_status" "enum_businesses_membership_status" DEFAULT 'pending',
  	"payment_status" "enum_businesses_payment_status" DEFAULT 'pending',
  	"approval_status" "enum_businesses_approval_status" DEFAULT 'pending',
  ...
  CREATE TABLE "_businesses_v_version_social_links" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"platform" "enum__businesses_v_version_social_links_platform",
  	"url" varchar,
  	"_uuid" varchar
  );
  ...
  CREATE TABLE "_businesses_v" (
  	...
  	"version_state" varchar DEFAULT 'VT',
  	...
  	"version_member_since" timestamp(3) with time zone,
  	"version_membership_expires" timestamp(3) with time zone,
  	"version_membership_tier" varchar,
  	"version_featured" boolean DEFAULT false,
  	"version_membership_status" "enum__businesses_v_version_membership_status" DEFAULT 'pending',
  	"version_payment_status" "enum__businesses_v_version_payment_status" DEFAULT 'pending',
  	"version_approval_status" "enum__businesses_v_version_approval_status" DEFAULT 'pending',
  	"version_approved_by_id" integer,
  	"version_approved_at" timestamp(3) with time zone,
  	"version_application_date" timestamp(3) with time zone,
  ...
  CREATE TABLE "_businesses_v_locales" (
  	...
  	"version_hours_of_operation" jsonb,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" integer NOT NULL
  );
  ...
  CREATE TABLE "users" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"name" varchar NOT NULL,
  	"role" "enum_users_role" DEFAULT 'business_member' NOT NULL,
  	"business_id" integer,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"email" varchar NOT NULL,
  ...
  CREATE TABLE "footer_locales" (
  	"copyright" varchar DEFAULT '© 2025 North Country Chamber of Commerce. All rights reserved.',
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" integer NOT NULL
  );
  ...
  CREATE TABLE "banners_active_banners" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"style" "enum_banners_active_banners_style" DEFAULT 'info' NOT NULL,
  ...
  CREATE TABLE "banners_active_banners_locales" (
  ...
  ALTER TABLE "businesses_social_links" ADD CONSTRAINT "businesses_social_links_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."businesses"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "businesses" ADD CONSTRAINT "businesses_approved_by_id_users_id_fk" FOREIGN KEY ("approved_by_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_businesses_v_version_social_links" ADD CONSTRAINT "_businesses_v_version_social_links_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_businesses_v"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_businesses_v" ADD CONSTRAINT "_businesses_v_version_approved_by_id_users_id_fk" FOREIGN KEY ("version_approved_by_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "banners_active_banners_locales" ADD CONSTRAINT "banners_active_banners_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."banners_active_banners"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "businesses_social_links_order_idx" ON "businesses_social_links" USING btree ("_order");
  CREATE INDEX "businesses_social_links_parent_id_idx" ON "businesses_social_links" USING btree ("_parent_id");
  ...
  CREATE INDEX "businesses_approved_by_idx" ON "businesses" USING btree ("approved_by_id");
  ...
  CREATE INDEX "_businesses_v_version_social_links_order_idx" ON "_businesses_v_version_social_links" USING btree ("_order");
  CREATE INDEX "_businesses_v_version_social_links_parent_id_idx" ON "_businesses_v_version_social_links" USING btree ("_parent_id");
  ...
  CREATE INDEX "_businesses_v_version_version_approved_by_idx" ON "_businesses_v" USING btree ("version_approved_by_id");
  ...
  CREATE INDEX "email_campaigns_news_item_idx" ON "email_campaigns" USING btree ("news_item_id");
  CREATE INDEX "email_campaigns_sent_by_idx" ON "email_campaigns" USING btree ("sent_by_id");
  ...
  CREATE INDEX "email_campaigns_rels_events_id_idx" ON "email_campaigns_rels" USING btree ("events_id");
  ...
  CREATE INDEX "banners_active_banners_order_idx" ON "banners_active_banners" USING btree ("_order");
  CREATE INDEX "banners_active_banners_parent_id_idx" ON "banners_active_banners" USING btree ("_parent_id");
  CREATE UNIQUE INDEX "banners_active_banners_locales_locale_parent_id_unique" ON "banners_active_banners_locales" USING btree ("_locale","_parent_id");`)
}
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "businesses_social_links" CASCADE;
  ...
  DROP TABLE "_businesses_v_version_social_links" CASCADE;
  ...
  DROP TABLE "banners_active_banners" CASCADE;
  DROP TABLE "banners_active_banners_locales" CASCADE;
  ...
  DROP TYPE "public"."enum_businesses_social_links_platform";
  DROP TYPE "public"."enum_businesses_advertising_slots_type";
  DROP TYPE "public"."enum_businesses_membership_status";
  DROP TYPE "public"."enum_businesses_payment_status";
  DROP TYPE "public"."enum_businesses_approval_status";
  DROP TYPE "public"."enum_businesses_status";
  DROP TYPE "public"."enum__businesses_v_version_social_links_platform";
  DROP TYPE "public"."enum__businesses_v_version_advertising_slots_type";
  DROP TYPE "public"."enum__businesses_v_version_membership_status";
  DROP TYPE "public"."enum__businesses_v_version_payment_status";
  ...
  DROP TYPE "public"."enum_banners_active_banners_style";`)
}
