...
export function ApproveEventButton({ eventId, eventTitle }: ApproveEventButtonProps) {
  ...
  const handleApprove = async () => {
    ...
    try {
      ...
      const response = await fetch(`/api/events/approve?id=${eventId}`, {
        method: 'GET',
        credentials: 'include',
      })
